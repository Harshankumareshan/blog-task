...
function Description({content})
{
    return<div className='description-wrapper'>
        ...
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut explicabo ipsa nihil qui animi doloribus laborum reprehenderit soluta consequuntur, alias, veritatis nesciunt placeat labore quas cumque quam rem quis expedita?
        </div>
    </div>
}
...
function Action({id,onDelete}){
    ...
    return <>
    <i className="fa-solid fa-pen" style={{cursor:"pointer"}}
